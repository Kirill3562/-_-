...
var FifteenthTitle = /** @class */ (function () {
    ...
    _a = FifteenthTitle, _FifteenthTitle_get = function _FifteenthTitle_get() {
        ...
        var itemWithTitle = resData.filter(function (item) { return item.id === __classPrivateFieldGet(FifteenthTitle, _a, "f", _FifteenthTitle_ID); });
        var title = itemWithTitle[0].title;
        return { title: title }; // или JSON.stringify(title) ?
    };
